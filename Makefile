...
#    Updated: 2022/07/20 23:09:55 by jefernan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= 	ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c \
			...
			ft_strdup.c ft_strlcat.c ft_strlcpy.c ft_strlen.c ft_strnstr.c  \
			ft_strrchr.c ft_strncmp.c ft_tolower.c ft_toupper.c ft_itoa.c  \
